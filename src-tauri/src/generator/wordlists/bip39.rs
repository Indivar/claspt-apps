...
//! The BIP-39 English word list as a static array.
//!
//! Standardized 2048-word list (indexable with 11 bits per word) originally
//! defined for cryptocurrency mnemonic seeds; here it is one of the two word
//! sources offered to the passphrase generator.

/// BIP-39 English word list — 2048 words for passphrase generation.
/// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
pub const BIP39_ENGLISH: &[&str] = &[
