 ...
 * 8880-element array literal the JS engine has to build eagerly.
 */

/** ISO date the list was retrieved, surfaced in tests so staleness is visible. */
export const PUBLIC_SUFFIX_LIST_DATE = "2026-09-04";

/** Newline-joined PSL rules. Parsed by `shared/url-matching.ts`. */
export const PUBLIC_SUFFIX_RULES = `!city.kawasaki.jp
!city.kitakyushu.jp
!city.kobe.jp
!city.nagoya.jp
!city.sapporo.jp
